...
2. 正文结束后必须另起一节，标题为「依据来源」，列出 2–5 条依据（权威文档 URL、教材/书名、标准规范名、参考资料文件名等均可；不确定时写你认为可靠的常见出处，并注明「参考」）。
